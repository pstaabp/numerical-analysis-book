...
{
  "id": "sect-convergence-sequence-4-2-2",
  "level": "2",
  "url": "sect-convergence-sequence.html#sect-convergence-sequence-4-2-2",
  "type": "Definition",
  "number": "2.3.2",
  "title": "",
...
{
  "id": "sect-convergence-sequence-4-2-3",
  "level": "2",
  "url": "sect-convergence-sequence.html#sect-convergence-sequence-4-2-3",
  "type": "Example",
  "number": "2.3.3",
  "title": "",
...
},
{
  ...
  "number": "2.3.4",
  "title": "",
  "body": "  Let be a sequence that converges to and be a sequence that converges to 0. If and for some such that , then converges with .   "
},
{
  "id": "sect-convergence-sequence-4-2-7",
  "level": "2",
  "url": "sect-convergence-sequence.html#sect-convergence-sequence-4-2-7",
  "type": "Example",
  "number": "2.3.5",
  "title": "",
...
{
  "id": "sect-convergence-sequence-4-4-4",
  "level": "2",
  "url": "sect-convergence-sequence.html#sect-convergence-sequence-4-4-4",
  "type": "Definition",
  "number": "2.3.6",
  "title": "",
...
{
  "id": "sect-convergence-sequence-4-4-7",
  "level": "2",
  "url": "sect-convergence-sequence.html#sect-convergence-sequence-4-4-7",
  "type": "Example",
  "number": "2.3.7",
  "title": "",
...
{
  "id": "sect-convergence-sequence-4-4-9",
  "level": "2",
  "url": "sect-convergence-sequence.html#sect-convergence-sequence-4-4-9",
  "type": "Example",
  "number": "2.3.9",
  "title": "",
...
},
{
  ...
  "number": "2.3.11",
  "title": "",
  "body": "  Find the order of convergence of the YASRA in .    First, build the following table of errors.   Table of errors for YASRA                                                                                                 Looking at the errors, they appear to be dropping in a linear way (each is about 1\/100 of the previous one), so we can determine if this is indeed the case with the following table of .   Using a table to estimate the convergence rate of YASRA                                                                 From this analysis, it appears that in fact, this method converges linearly and with asymptotic error constant .   "
},
{
...
{
  "id": "sect-convergence-sequence-5-4",
  "level": "2",
  "url": "sect-convergence-sequence.html#sect-convergence-sequence-5-4",
  "type": "Example",
  "number": "2.3.18",
  "title": "",
...
},
{
  ...
  "number": "3.1.1",
  "title": "",
  "body": "  Find the area bounded by the -axis, the line and the line in the first quadrant.  The area sought is the shaded area below:          The area is the definite integral of the difference of the two curves. However, the limits on the integral depend on the intersection point which means solving: or finding the root of .   "
},
{
  ...
  "number": "3.1.3",
  "title": "",
  "body": "  Find the maximum of for .    This means solving which does not have a closed form solution.   "
},
{
  "id": "def-multiplicity",
  "level": "2",
...
{
  "id": "sect-intro-rootfinding-13",
  "level": "2",
  "url": "sect-intro-rootfinding.html#sect-intro-rootfinding-13",
  "type": "Example",
  "number": "3.1.6",
  "title": "",
...
},
{
  ...
  "number": "3.2.1",
  "title": "",
  "body": "  Show that the function has a root on .    We know that is continuous on the interval and and , and since this satisfies the IVT, there must exist a number such that , and this is the definition of a root.   "
},
{
  "id": "fig-bisection",
  "level": "2",
...
},
{
  ...
  "number": "3.3.4",
  "title": "",
  "body": "  Run the iterations where and . That is evaluate the fixed point iteration for with given initial point.       This appears to be converging to about the value of 0.7391.   "
},
{
...
},
{
  ...
  "number": "3.3.6",
  "title": "",
  "body": "  Run the fixed point iteration for when the function is .       Notice in this case that the iteration did not converge nor result in finding the intersection point.   "
},
{
  "id": "thm-fixed-pt",
  "level": "2",
...
},
{
  ...
  "number": "3.3.8",
  "title": "",
  "body": "  Let be continuous on the closed interval with . Furthermore, suppose that is differentiable on the open interval and there exists a positive constant such that for all . Then     the sequence generated by converges to the fixed point for any ;     ; and     .      "
},
{
...
},
{
  ...
  "number": "3.3.12",
  "title": "",
  "body": "  Prove using that the method given by   converges to quadratically and find the asymptotic error constant,   First, note that is continuous and differentiable (to any order) on an interval not containing .  Next, note that so is a fixed point.     Since and , this method converges and converges quadratically. The asymptotic error constant is , which we saw in Example ex:conv:rate:newt:sqrt.   "
},
{
  "id": "sect-fixed-point-4-11",
  "level": "2",
  "url": "sect-fixed-point.html#sect-fixed-point-4-11",
  "type": "Example",
  "number": "3.3.13",
  "title": "",
...
},
{
  ...
  "number": "3.3.14",
  "title": "TITLE",
  "body": " TITLE                1  0.0147059    2  0.0111205    3  0.0051975    4  0.0038599    5  0.0038462    6  0.0038462    7  0.0038462    "
},
{
...
},
{
  ...
  "number": "5.1.1",
  "title": "",
  "body": "  Use the 3-point forward difference formula in (eq:num:diff:3pt:forward) above to estimate if and and . Provide a theoretical error bound and compare it to the actual derivative.    First, the forward difference formula applied to this problem is and recall that .  The theoretical error bound is and since the actual error is 0.083, within the theoretical error bound.   "
},
{
  ...
  "number": "5.1.2",
  "title": "",
  "body": "  Find the 5-point center difference formula for using a Computer Algebra System:    We will use Maple commands here. First, we will need the CurveFitting package.   with(CurveFitting):   Create the polynomial:   Pn:=PolynomialInterpolation([seq([ , ],i=0..4)],z):   where the colon is used to suppress the output. You may remove it to see a number of pages of output. Note: this is a polynomial in because the points are chosen to be in term of .  Next, differentiate the interpolating polynomial:   dPn:=diff(Pn,z):   and then substitute in the points. The polynomial is to be evaluated at and then the other points are written in terms of and .   simplify(eval(dPn, , , , , ))   and the output should be which can be written back in terms of as:   This is the 5-point difference formula for at , the center point. Note that is missing from the formula. This is similar to the center point missing in the 3-point formula for in .   "
},
{
...
{
  "id": "sect-intro-quadature-7-8",
  "level": "2",
  "url": "sect-intro-quadature.html#sect-intro-quadature-7-8",
  "type": "Example",
  "number": "5.2.7",
  "title": "",
...
},
{
  ...
  "number": "5.3.1",
  "title": "",
  "body": "  Find using the composite trapezoid rule with . Find a bound on the error.    In this case .   To find a bound on the error, we use (eq:error:comp:trap) and need a bound on the second derivative of . It can be shown that and this reaches a maximum (in absolute value) at , so . Using ,   Recall that this is a theoretical error bound and the actual error is about .   "
},
{
...
},
{
  ...
  "body": " Interval Arithmetic  hi there  "
},
{
  "id": "backmatter-2",
  "level": "1",
